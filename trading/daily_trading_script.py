...
def calculate_total_gas_consumed(current_date) -> float:
    ...
    for state in us_state_to_abbrev_supported_for_trading:
        daily_values, diff_pct = calculate_eia_daily_values(start_date,
                                                    end_date,
                                                    "2025-01-01",
                                                    "2025-10-31",
                                                    "2016-01-01",
...
def calculate_total_day_over_day_gas_difference(current_date = datetime.datetime.now()):
    ...
    return current_date_total_gas - previous_date_total_gas
...
if __name__ == "__main__":
    ...
    day_over_day_difference = calculate_day_over_day_difference("2026-01-01",
                                                                "2026-01-09")
