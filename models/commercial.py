...
TODO: Should I look to refactor the code provided here?
TODO:
"""
...
class CommercialModel(Model):
    """
    States the Commercial Model that will be used to calculate natural gas
    consumption.
...
def get_eia_commercial_data(start_date: datetime.date, end_date: datetime.date):
    """
...
def fit_commercial_model(start_training_time: str,
    ...
    if method == "GLOBAL":
        best_parameters, optimal_rel_error = CommercialModel(calibrated_parameters,
